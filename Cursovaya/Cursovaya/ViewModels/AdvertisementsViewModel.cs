...
public class AdvertisementsViewModel : ViewModelBase, IRefreshableViewModel
{
        ...
        Func<Advertisement?, Task> openAddEdit)
    {
        ...
        {
            new() { Title = "Newest first", Value = "date_desc", ResourceKey = "SortNewest" },
            new() { Title = "Price low to high", Value = "price_asc", ResourceKey = "SortPriceAsc" },
            new() { Title = "Price high to low", Value = "price_desc", ResourceKey = "SortPriceDesc" },
            new() { Title = "By title", Value = "title", ResourceKey = "SortTitle" }
        };
