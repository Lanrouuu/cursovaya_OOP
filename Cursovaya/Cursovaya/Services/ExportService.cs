...
public class ExportService
{
    public bool ExportUsers(IEnumerable<User> users)
    {
        ...
        {
            Title = LocalizedStrings.Get("ExportUsers"),
            Filter = LocalizedStrings.Get("CsvDialogFilter"),
        ...
        writer.WriteLine(LocalizedStrings.Get("CsvUsersHeader"));
    ...
    public bool ExportAdvertisements(IEnumerable<Advertisement> advertisements)
    {
        var dialog = new SaveFileDialog
        {
            Title = LocalizedStrings.Get("ExportAdvertisements"),
            Filter = LocalizedStrings.Get("CsvDialogFilter"),
        ...
        using var writer = new StreamWriter(dialog.FileName, false, Encoding.UTF8);
        writer.WriteLine(LocalizedStrings.Get("CsvAdvertisementsHeader"));
